...
## Purpose
Define the workflow for scenario-driven test design: user scenarios are declared in proposal.md, test scope selection criteria are managed in testing.md, review decisions are accumulated in specs/testing-decision-log.md (referenced from testing.md), and scenarios are promoted to spec.md at archive time.
